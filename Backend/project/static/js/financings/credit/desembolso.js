...
const campos = ['monto', 'poliza_seguro', 'honorarios', 'credito_saldo_capital_vigente'];
campos.forEach(id => {
...
export function actualizarTotalDepositar() {
    ...
    let gastos = parseFloat(poliza_seguro) + parseFloat(honorarios) + parseFloat(saldo_anterior);

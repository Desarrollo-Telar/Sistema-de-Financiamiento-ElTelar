...
urlpatterns = [
    ...
    path('credit/clasificar/',views.list_clasificacion, name='list_clasificacion'),
    path('credit/excedente/',views.filter_credito_con_excedente, name='filter_credito_con_excedente'),
    path('credit/clasificacion_mes_anio/',views.filter_credito_por_mes_anio, name='filter_credito_por_mes_anio'),

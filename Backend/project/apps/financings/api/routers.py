...
router.register(r'credit-vigente-cobranza',views.CreditVigentesCobranzaViewSet,'credit-vigente-cobranza')
...
router.register(r'condiciones_credito', views.CondicionesCreditoViewSet, 'condiciones_credito')

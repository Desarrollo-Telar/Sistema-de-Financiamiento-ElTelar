...
def realizar_pago(credito_id, fecha_emision, monto_pago, payment):
    try:
        ...
        for cuota in cuotas:
            ...
            interes_generado = calcular_interes(cuota.outstanding_balance, cuota.interest, cuota.start_date, fecha_pago, fecha_emision)
        ...
        # Si queda monto restante, aplicarlo a la siguiente cuota
        ...
        return f"Pago de {monto_pago} realizado exitosamente. Saldo restante: {saldo_pendiente}"

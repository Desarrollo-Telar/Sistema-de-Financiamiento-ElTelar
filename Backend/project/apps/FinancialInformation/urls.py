...
urlpatterns = [
    ...
    path('create/gastos_cliente/<str:customer_code>/',views.create_gastos_cliente, name='create_gastos_cliente'),
    ...
    path('seleccionar/<str:customer_code>/', views.seleccionar, name='seleccionar'),
]

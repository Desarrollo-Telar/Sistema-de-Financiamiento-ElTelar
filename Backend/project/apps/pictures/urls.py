...
urlpatterns = [
    ...
    path('create_image/address/<int:id>/<str:customer_code>/', views.create_imagen_customer_address, name='create_image_address'),
    path('create_image/guarantee/<int:id>/<str:customer_code>/', views.create_imagen_customer_guarantee, name='create_image_guarantee'),

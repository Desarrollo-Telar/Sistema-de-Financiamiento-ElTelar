    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Revisión de documentos', 'Revisión de documentos'), ('Aprobado', 'Aprobado'), ('No Aprobado', 'No Aprobado'), ('Posible Cliente', 'Posible Cliente')], default='Posible Cliente', max_length=75, verbose_name='Estado')),
                ...
                ('person_type', models.CharField(choices=[('Individual (PI)', 'Individual (PI)'), ('Jurídica (PJ)', 'Jurídica (PJ)')], max_length=50, verbose_name='Tipo de Persona')),

...
urlpatterns_notificaciones = [
    ...
    path('boletas_clientes/', login_required(views.DocumentoNotificacionClientesList.as_view()), name='listar_boletas_subidas'),
    ...
    path('boletas_clientes/actualizar/<int:id>/',views.cambio_referencia_boleta, name='cambio_referencia_boleta'),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('Administrador', 'Administrador'), ('Administradora', 'Administradora'), ('Programador', 'Programador'), ('Programadora', 'Programadora'), ('Secretaria', 'Secretaria'), ('Secretario', 'Secretario'), ('Contador', 'Contador'), ('Contadora', 'Contadora')], default='Administrador', max_length=50, verbose_name='Rol de Usuario')),
